...
搭建的静态博客利用 Markdown 码字，必然少不了图片，所以需要另外的图床作为辅助，网上有很多优秀的图床程序，不过大多都功能复杂，而且图片放在别人那，让我总感觉不是很放心（万一哪天就跑路了呢？），而自己来搭建图床程序的话，需要自备服务器或者是虚拟主机，这个可是要付费的，毕竟自己的博客都是利用免费的Pages服务搭建的，而再为了托管图片去付费就有些得不偿失了，所以我想了半天，折腾了半天，可以利用腾讯云旗下的Cloud Studio的WebIDE及代码托管平台来搭建图床，步骤如下：
...
- 新建一个项目
  ...
  ![新建项目](https://api.mahoo12138.cn/minio-blog/Tutorials/pic_cs/new.png)

  项目名称，地址自定义，是否公开勾选。

  ![新建项目](https://api.mahoo12138.cn/minio-blog/Tutorials/pic_cs/new1.png)

进入新建项目界面，打开右侧`代码 ->代码浏览 `，复制该项目的HTTPS地址。

![项目界面](https://api.mahoo12138.cn/minio-blog/Tutorials/pic_cs/new2.png)
...
![](https://api.mahoo12138.cn/minio-blog/Tutorials/pic_cs/pages.png)
...
new = 'https://api.mahoo12138.cn/minio-blog/Tutorials/pic_cs/'
...
for i in range(len(files[2])):
    ...
    new = 'https://api.mahoo12138.cn/minio-blog/'		#新域名
    string = re.sub(key, new, string)
