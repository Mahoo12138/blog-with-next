...
router.get('/webapi/learn/show', async (ctx) => {
  ...
  shelljs.exec(
    `mv /sdcard/Pictures/pic.png /data/data/com.termux/files/home/big-study/static/img/pic.png`
  )
