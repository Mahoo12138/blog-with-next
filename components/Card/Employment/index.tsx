...
const EmploymentCard = (props: EmploymentCardProps) => {
  ...
  return (
    <div className="flex w-full flex-col gap-y-2 rounded-md border bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div className="text-normal px-4.5 flex w-full items-center justify-between gap-x-2.5 overflow-hidden overflow-x-auto whitespace-nowrap border-b border-gray-200 py-2.5 font-medium tracking-wide text-gray-700 dark:border-gray-700 dark:text-white">
      ...
      {organizationFullName && (
        <div className="px-4.5 -mt-[8px] flex items-center border-t border-gray-200 py-1.5 dark:border-gray-700">
